 ...
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.micobs.doctpl.doc.impl.DListItemImpl#getParagraph <em>Paragraph</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.doctpl.doc.impl.DListItemImpl#getSublist <em>Sublist</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DListItemImpl extends MinimalEObjectImpl.Container implements DListItem {
	...
	protected EClass eStaticClass() {
		return docPackage.Literals.DLIST_ITEM;
	}
	...
	public EList<DParagraph> getParagraph() {
		if (paragraph == null) {
			paragraph = new EObjectContainmentEList<DParagraph>(DParagraph.class, this, docPackage.DLIST_ITEM__PARAGRAPH);
		}
		return paragraph;
	}
	...
	public NotificationChain basicSetSublist(DListContent newSublist, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, docPackage.DLIST_ITEM__SUBLIST, oldSublist, newSublist);
	...
	public void setSublist(DListContent newSublist) {
		if (newSublist != sublist) {
			...
			if (sublist != null)
				msgs = ((InternalEObject)sublist).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - docPackage.DLIST_ITEM__SUBLIST, null, msgs);
			if (newSublist != null)
				msgs = ((InternalEObject)newSublist).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - docPackage.DLIST_ITEM__SUBLIST, null, msgs);
			msgs = basicSetSublist(newSublist, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, docPackage.DLIST_ITEM__SUBLIST, newSublist, newSublist));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case docPackage.DLIST_ITEM__PARAGRAPH:
				return ((InternalEList<?>)getParagraph()).basicRemove(otherEnd, msgs);
			case docPackage.DLIST_ITEM__SUBLIST:
