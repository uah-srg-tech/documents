 ...
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.micobs.doctpl.doc.impl.DBodyImpl#getBodyContent <em>Body Content</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DBodyImpl extends MinimalEObjectImpl.Container implements DBody {
	...
	public EList<DBodyContent> getBodyContent() {
		if (bodyContent == null) {
			bodyContent = new EObjectContainmentEList<DBodyContent>(DBodyContent.class, this, docPackage.DBODY__BODY_CONTENT);
		}
		return bodyContent;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case docPackage.DBODY__BODY_CONTENT:
