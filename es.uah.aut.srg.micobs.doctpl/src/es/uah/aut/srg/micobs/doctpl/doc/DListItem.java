 ...
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.micobs.doctpl.doc.DListItem#getParagraph <em>Paragraph</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.doctpl.doc.DListItem#getSublist <em>Sublist</em>}</li>
 * </ul>
 *
 * @see es.uah.aut.srg.micobs.doctpl.doc.docPackage#getDListItem()
 * @model
 * @generated
 */
public interface DListItem extends EObject {
	 ...
	 * The list contents are of type {@link es.uah.aut.srg.micobs.doctpl.doc.DParagraph}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see es.uah.aut.srg.micobs.doctpl.doc.docPackage#getDListItem_Paragraph()
	 ...
	 * @see es.uah.aut.srg.micobs.doctpl.doc.docPackage#getDListItem_Sublist()
	...
	/**
	 * Sets the value of the '{@link es.uah.aut.srg.micobs.doctpl.doc.DListItem#getSublist <em>Sublist</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
