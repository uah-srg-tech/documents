 ...
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.micobs.doctpl.doc.impl.DHyperlinkImpl#getRun <em>Run</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.doctpl.doc.impl.DHyperlinkImpl#getReference <em>Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DHyperlinkImpl extends DParagraphContentImpl implements DHyperlink {
	...
	protected EClass eStaticClass() {
		return docPackage.Literals.DHYPERLINK;
	}
	...
	public NotificationChain basicSetRun(DRun newRun, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, docPackage.DHYPERLINK__RUN, oldRun, newRun);
	...
	public void setRun(DRun newRun) {
		if (newRun != run) {
			...
			if (run != null)
				msgs = ((InternalEObject)run).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - docPackage.DHYPERLINK__RUN, null, msgs);
			if (newRun != null)
				msgs = ((InternalEObject)newRun).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - docPackage.DHYPERLINK__RUN, null, msgs);
			msgs = basicSetRun(newRun, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, docPackage.DHYPERLINK__RUN, newRun, newRun));
	}
	...
	public DReferenceableObject getReference() {
		if (reference != null && reference.eIsProxy()) {
			...
			if (reference != oldReference) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, docPackage.DHYPERLINK__REFERENCE, oldReference, reference));
			}
		}
		return reference;
	}
	...
	public void setReference(DReferenceableObject newReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, docPackage.DHYPERLINK__REFERENCE, oldReference, reference));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case docPackage.DHYPERLINK__RUN:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case docPackage.DHYPERLINK__RUN:
				return getRun();
			case docPackage.DHYPERLINK__REFERENCE:
