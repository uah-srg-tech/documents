 ...
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.micobs.doctpl.doctpl.impl.DAbstractSectionImpl#getSubsections <em>Subsections</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DAbstractSectionImpl extends MinimalEObjectImpl.Container implements DAbstractSection {
	...
	protected EClass eStaticClass() {
		return doctplPackage.Literals.DABSTRACT_SECTION;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case doctplPackage.DABSTRACT_SECTION__SUBSECTIONS:
