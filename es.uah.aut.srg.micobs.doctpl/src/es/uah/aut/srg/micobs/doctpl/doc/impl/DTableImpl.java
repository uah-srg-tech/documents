 ...
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.micobs.doctpl.doc.impl.DTableImpl#getRows <em>Rows</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DTableImpl extends DAbstractTableImpl implements DTable {
	/**
	...
	protected EClass eStaticClass() {
		return docPackage.Literals.DTABLE;
	}
	...
	public EList<DRow> getRows() {
		if (rows == null) {
			rows = new EObjectContainmentEList<DRow>(DRow.class, this, docPackage.DTABLE__ROWS);
		}
		return rows;
	}
