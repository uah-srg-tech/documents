 ...
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.micobs.doctpl.doctpl.impl.DFigureFromFileImpl#getReferenceFile <em>Reference File</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.doctpl.doctpl.impl.DFigureFromFileImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link es.uah.aut.srg.micobs.doctpl.doctpl.impl.DFigureFromFileImpl#getHeight <em>Height</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DFigureFromFileImpl extends DAbstractFigureImpl implements DFigureFromFile {
	...
	protected EClass eStaticClass() {
		return doctplPackage.Literals.DFIGURE_FROM_FILE;
	}
	...
	public void setReferenceFile(String newReferenceFile) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, doctplPackage.DFIGURE_FROM_FILE__REFERENCE_FILE, oldReferenceFile, referenceFile));
	}
	...
	public void setWidth(String newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, doctplPackage.DFIGURE_FROM_FILE__WIDTH, oldWidth, width));
	}
	...
	public void setHeight(String newHeight) {
		...
		height = newHeight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, doctplPackage.DFIGURE_FROM_FILE__HEIGHT, oldHeight, height));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case doctplPackage.DFIGURE_FROM_FILE__REFERENCE_FILE:
				return getReferenceFile();
			case doctplPackage.DFIGURE_FROM_FILE__WIDTH:
				return getWidth();
			case doctplPackage.DFIGURE_FROM_FILE__HEIGHT:
				return getHeight();
		}
