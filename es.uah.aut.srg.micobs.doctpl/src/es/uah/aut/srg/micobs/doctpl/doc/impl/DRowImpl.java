 ...
 * </p>
 * <ul>
 *   <li>{@link es.uah.aut.srg.micobs.doctpl.doc.impl.DRowImpl#getCells <em>Cells</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DRowImpl extends MinimalEObjectImpl.Container implements DRow {
	...
	public EList<DCell> getCells() {
		if (cells == null) {
			cells = new EObjectContainmentEList<DCell>(DCell.class, this, docPackage.DROW__CELLS);
		}
		return cells;
	}
