...
public class docPackageImpl extends EPackageImpl implements docPackage {
	...
	public EReference getDAbstractRelatedDocument_RefDocument() {
		return (EReference)dAbstractRelatedDocumentEClass.getEStructuralFeatures().get(5);
	}
...
=======
		...
		initEReference(getDHyperlink_Reference(), this.getDReferenceableObject(), null, "reference", null, 0, 1, DHyperlink.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
>>>>>>> branch 'master' of git@github.com:uah-srg-tech/documents.git
